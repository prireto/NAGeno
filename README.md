...
#### Test output data
The generated output files for the provided test data are displayed below.
Additionally, per sample vcf files, vcf collection files for all samples, filtered fastq and filtered bam files as well as more detailed bam depth data will be saved in the analysis directory along with log files and htmls files generated by fastplong and SnpEff.

#### Table 1 – SNV genotyping results (all SNVs): [`SNV_genotyping_results.tsv`](SNV_genotyping_results.tsv)
...
#### Table 2 – SNV genotyping results (protein-coding SNVs): [`Prot_coding_SNV_genotyping_results.tsv`](Prot_coding_SNV_genotyping_results.tsv)
| SAMPLE | GENE | CHROM | HGVS.p | HGVS.c | AF | POS | REF | ALT | GQ | DP | FILTER | GT | AD | QUAL | Annotation | Annotation_Impact | Feature_ID | mutGeneID.p | mutGeneID.c |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| S3 | SF3B1 | chr2 | p.Arg625Gly | c.1873C>G | 0.3057 | 197402760 | G | C | 64 | 2787 | PASS | 0/1 | 1933;852 | 64.2183 | missense_variant | MODERATE | NM_012433.4 | p.Arg625Gly_SF3B1 | c.1873C>G_SF3B1 |
| S3 | GNAQ | chr9 | p.Arg210Lys | c.629G>A | 0.4074 | 77794569 | C | T | 60 | 4534 | LowQual;StrandBias | 0/1 | 2658;1847 | 0 | missense_variant | MODERATE | NM_002072.5 | p.Arg210Lys_GNAQ | c.629G>A_GNAQ |
...
#### Table 3 – Summary of depth statistics: [`Summary_depth_stats.tsv`](tutorial/test_output/depth/Summary_depth_stats.tsv)
...
#### Plot 1 – Allele frequency plot (protein-coding SNVs): [`Prot_coding_SNV_genotyping_results.svg`](tutorial/test_output/Prot_coding_SNV_genotyping_results.svg)
<p align="left">
...
#### Plot 2 – Allele frequency plot (all SNVs): [`SNV_genotyping_results.svg`](tutorial/test_output/SNV_genotyping_results.svg)
<p align="left">
  <img src="tutorial/test_output/SNV_genotyping_results.svg" width="440" alt="SNVs of tutorial test data">
</p>

#### Plots 3-x – Per sample, per gene depth plots: [`[GENE]_by_sample_[FILTER].svg` and `[GENE]_[FILTER].svg`](tutorial/test_output/depth)
<!-- First 2×2 block -->
<table>
  <tr>
