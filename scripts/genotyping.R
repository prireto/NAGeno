...
# plot all SNVs and only prot-coding SNVs w GQ>=10 (SNV_genotyping_results.tsv, Prot_coding_SNV_genotyping_results.tsv) and export filtered cols for SNVs, prot-coding SNVs, and indels (SNV_genotyping_results.tsv, Prot_coding_SNV_genotyping_results.tsv, Indel_genotyping_results.tsv)
...
# fill missing values with AF to make plot better - assumes that whole amplicon is covered for each sample
